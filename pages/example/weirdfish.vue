<template>
    <div class="body-waterized-oceanic">
        <p class="indicator">
            <span class="text-xl sm:text-4xl">Scroll&nbsp;&nbsp;</span>
            <span>↓</span>
        </p>
        ...
        <div class="content">
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">In the deepest ocean</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">the bottom of the sea</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">Your eyes...</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">they turn me...</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">turn me on to phantoms</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">I follow to the edge of the earth</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">and fall off</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">I get eaten by the worms</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">and weird fishes</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">Hit the bottom and escape</p>
                </div>
            </section>
            <section>
                <div class="section__content">
                    <p class="text-xl sm:text-4xl opacity-0">escape</p>
                </div>
            </section>
        </div>
    </div>
